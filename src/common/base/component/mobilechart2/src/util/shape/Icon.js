...
define(function(require) {
	...
	var CandleShape = require('../shape/Candle');
	...
	function _legendLineIcon(ctx, style, refreshNextFrame) {
		var x = style.x;
		var y = style.y;
		...
		symbol = Icon.prototype.iconLibrary[symbol];
	...
	function _legendPieIcon(ctx, style,refreshNextFrame) {
            var x = style.x;
            var y = style.y;
            var width = style.width;
            var height = style.height;
    ...
    function _legendKIcon(ctx, style,refreshNextFrame) {
    	 var x = style.x;
            var y = style.y;
            var width = style.width;
            var height = style.height;
    ...
    function _legendRadarIcon(ctx, style,refreshNextFrame) {
    	 	var n = 6;
	...
	Icon.prototype = {
		...
		iconLibrary: {
			...
			legendLineIcon: _legendLineIcon,

			legendPieIcon : _legendPieIcon,
			legendKIcon:_legendKIcon,
			legendRadarIcon:_legendRadarIcon,
